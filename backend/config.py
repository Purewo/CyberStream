...
# --- 托管 OpenList / 天翼云盘 / 115 云盘 / QuarkTV / UCTV ---
# OpenList 与 AList 分开运行：当前 AList 负责光鸭，OpenList 负责 189CloudTV、
# 115 Cloud、QuarkTV、UCTV 扫码登录。OpenList 同样只绑定本机地址，由后端解析播放 302 直链。
...
SUBTITLE_MANUAL_UPLOAD_MAX_BYTES = _env_int('CYBER_SUBTITLE_MANUAL_UPLOAD_MAX_BYTES', 0)
SUBTITLE_WEBVTT_CONVERSION_MAX_BYTES = _env_int(
    'CYBER_SUBTITLE_WEBVTT_CONVERSION_MAX_BYTES',
    0,
)
ONLINE_SUBTITLE_EXTRACTED_MAX_BYTES = _env_int('CYBER_ONLINE_SUBTITLE_EXTRACTED_MAX_BYTES', 0)
ONLINE_SUBTITLE_NESTED_ARCHIVE_MAX_BYTES = _env_int('CYBER_ONLINE_SUBTITLE_NESTED_ARCHIVE_MAX_BYTES', 0)
